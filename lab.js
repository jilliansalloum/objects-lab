...
user.email = 'bryansmith@devmountain.in'
console.log(user)
//////////////////////////// PROBLEM 11 ////////////////////////////
/*
...
let simba = new Cat('simba',15,'white')
...
let jillian = new Wizard('jillian', 26, 'obliviate')
jillian.castSpell()
...
//Code Here
let iPhone = new Phone('apple','13pro',48,'black',1000)
let android = new Phone('android','lsnote',32,'white',800)
let google = new Phone('google','pixel',16,'green',600)
...
//Code Here
let myFirstVehicle = new Vehicle(6,'green',100000)
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(6,'black',13000)
/*
...
//Code Here
let yacht = new Boat(20,'white',20000,'portofino','very cool','majestic','yacht',true)
